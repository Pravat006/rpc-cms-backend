...
const navigationItemSchema = new mongoose_1.Schema({
    ...
    path: { type: String },
    page: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Page' },
...
(0, mongooseToJSON_1.default)(navigationSchema);
exports.Navigation = mongoose_1.default.models.Navigation || mongoose_1.default.model("Navigation", navigationSchema);
